...
const categories: Record<string, LocalizedText> = {
  ...
  localization: { ru: "Тестирование локализации", en: "Localization Testing" },
  accessibility: { ru: "Тестирование доступности", en: "Accessibility Testing" },
  mobile: { ru: "Мобильное тестирование", en: "Mobile Testing" },
  automation: { ru: "Автоматизация", en: "Test Automation" },
